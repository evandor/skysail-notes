...
//  
//  val resources: LinkedHashMap[String, ResourceModel] = scala.collection.mutable.LinkedHashMap()
//  
//  val entityModels:  LinkedHashMap[String, EntityModel] = scala.collection.mutable.LinkedHashMap()
//
...
//   */
//  def addOnce[T <: ResourceModel](resourceModel: T ): Unit = {
